...
namespace ArcadeVP
{
    public class ArcadeVehicleController : MonoBehaviour
    {
       ...
       Mybutton GasButton;
       Mybutton BreakButton;
       Mybutton rightButton;
       Mybutton leftButton;
       Mybutton HandbreakButton;
        ...
        private void Start()
        {
            ...
            GasButton = GameObject.Find("GAS").GetComponent<Mybutton>();
            BreakButton = GameObject.Find("Break").GetComponent<Mybutton>();
            rightButton = GameObject.Find("Right").GetComponent<Mybutton>();
            leftButton = GameObject.Find("Left").GetComponent<Mybutton>();
            HandbreakButton=GameObject.Find("handBreak").GetComponent<Mybutton>();
        ...
        private void Update()
        {
            ...
            {
                verticalInput += GasButton.dampenPress;
            }

            if (BreakButton.isPressed)
            {
                verticalInput -= BreakButton.dampenPress;
            }
        ...
        void FixedUpdate()
        {
            if (Mathf.Abs(carVelocity.x) > 10 && grounded()&&Input.GetAxis("Jump") > 0.1f || HandbreakButton.isPressed)
            {

                //deleveryManager.isdrifting = true;
            }
            ...
            if (grounded())
            {
                ...
                if (kartLike && Input.GetAxis("Jump") > 0.1f  || kartLike &&HandbreakButton.isPressed) { TurnMultiplyer *= driftMultiplier; } //turn more if drifting
                ...
                if (!kartLike)
                {
                    if (Input.GetAxis("Jump") > 0.1f||HandbreakButton.isPressed)
                    {
